      ...
      <main className="main-content min-h-screen bg-[var(--bg-main)]">
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch w-full">
            ...
            {/* Jadwal Rapat */}
            <div className="solid-card w-full h-full max-h-[600px] overflow-y-auto" style={{ padding: "24px" }}>
              ...
              <div>
                {filteredMeetings.filter(m => m.status === "Scheduled").length === 0 ? (
                  ...
                  {filteredMeetings.filter(m => m.status === "Scheduled").map((m) => (
                    <div key={m.id} className="flex flex-col md:flex-row md:items-center justify-between py-8 md:py-10 border-b border-[var(--border-color)] last:border-0 gap-4 md:gap-6 max-md:-mx-4 max-md:px-4 -mx-6 px-6">
          ...
          <div className="w-full">
            {/* Riwayat Rapat */}
            <div className="solid-card w-full" style={{ padding: "24px" }}>
              ...
              <div>
                {filteredMeetings.filter(m => m.status === "Completed").length === 0 ? (
                  ...
                  {filteredMeetings.filter(m => m.status === "Completed").map((m) => (
                    <div key={m.id} className="flex flex-col md:flex-row md:items-center justify-between py-8 md:py-10 border-b border-[var(--border-color)] last:border-0 gap-4 md:gap-6 opacity-85 max-md:-mx-4 max-md:px-4 -mx-6 px-6">
                      <div className="flex items-center gap-4 flex-1 min-w-0">
